...
public class Settings {
    ...
    public static final long SEND_FINISH_DELAY_DEFAULT = 10000L;
    public static final long SEND_FINISH_DELAY_MIN = 1000L;
    ...
    public static final int EXCEL_ROW_COUNT_MAX = 1000;
